...
""" The game requires 2 players. Everytime 
the paddle hits the ball the speed is increased 
10% horizontally. 
Controlling the paddles:
Player1: W is up, S is down
Player2: up arrow is up, down arrow is down
* Dependency: run this code on codeskulptor.org
By Yuttanant Suwansiri 16 May 2013
"""
import simplegui
import random
